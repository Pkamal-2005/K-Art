    ...
    <div class="container">
        <header>
            ...
            <div class="nav-links">
                ...
                <a href="checkout" class="nav-link"><i class="fas fa-credit-card"></i> Checkout</a>
            </div>
        </header>
        ...
        <c:if test="${not empty cartItems}">
            <div class="cart-container">
                ...
                <div class="cart-actions">
                    <h3 class="action-title"><i class="fas fa-shopping-cart"></i> Cart Summary</h3>
                    <div class="action-buttons">
                        <a href="checkout" class="checkout-btn" style="text-decoration: none;">
